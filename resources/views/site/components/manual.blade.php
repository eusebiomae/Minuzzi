...
<section class="section section-variant-1 bg-default novi-bg novi-bg-img"
	...
	<div class="container-wide">
			<div class="row justify-content-xl-end row-30">
					...
					<div class="col-xl-3 text-xl-end"><a class="button button-secondary button-nina" href="/blog">ver todos</a></div>
			</div>
							...
							<article class="event-default-wrap">
									<div class="event-default">
											...
											<div class="event-default-caption"><a
															...
															href="blog_details/{{$event->id}}">ver detalhes</a></div>
									</div>
									<div class="event-default-inner">
											...
											<h5><a class="event-default-title" href="single-event.html">{{ $event->title_pt }}</a></h5>
									</div>
							</article>
						</div>
						@endforeach
